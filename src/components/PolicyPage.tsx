      ...
      <main className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-lg shadow-lg">
          ...
          <PolicySection id="shipping-policy">
            ...
            <div className="space-y-4 text-text-muted">
                <h3 className="text-xl font-bold text-text">Digital Products</h3>
                ...
                <p>Upon successful payment, you will receive immediate access to your purchased products via email and in the "My Purchases" section of your account. Access is typically granted within 5-10 minutes of payment confirmation.</p>
            </div>
          </PolicySection>
          ...
          <PolicySection id="refund-policy">
            ...
            <div className="space-y-4 text-text-muted">
                ...
                <p>Due to the nature of digital products, all sales are non-refundable once the product has been accessed or downloaded.</p>
                <h3 className="text-xl font-bold text-text pt-4">Exceptions</h3>
                <p>For technical issues where the product cannot be accessed, please contact support within 7 days. We will work to resolve the issue or provide a refund if access cannot be restored.</p>
            </div>
          </PolicySection>
          ...
          <PolicySection id="contact-us">
            ...
            <div className="space-y-4 text-text-muted">
                ...
                <ul className="list-disc list-inside space-y-2">
                    ...
                    {/* RAZORPAY MANDATORY REQUIREMENT: REGISTERED ADDRESS */}
                    <li><strong>Registered Address:</strong> <span className="text-gray-800">Shiv Nagar, Turkahiya, Gandhi Nagar, Basti, Uttar Pradesh, India - 272001</span></li>
                </ul>
            </div>
          </PolicySection>
