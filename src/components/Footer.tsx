        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              {/* ADDED: Shipping Policy & Contact Us links for Razorpay Compliance */}
              <li><button onClick={() => onNavigateToPolicies('shipping-policy')} className="hover:text-white transition-colors">Shipping Policy</button></li>
              <li><button onClick={() => onNavigateToPolicies('contact-us')} className="hover:text-white transition-colors">Contact Us</button></li>
              
              <li><button onClick={onLoginClick} className="hover:text-white transition-colors mt-2 block border-t border-white/20 pt-2">Login / Register</button></li>
